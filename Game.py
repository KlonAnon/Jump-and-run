...
enemyList = []
    #background
bg1 = Background(win_width, win_height, x=0, y=0, vel=8, img=os.path.join("images", "bg-1.png"))
bg2 = Background(win_width, win_height, x=win_width, y=0, vel=8, img=os.path.join("images", "bg-1.png"))
    #ground
ground1 = Ground(width= 500, height=250, x=0, y=350, vel=10, img=os.path.join("images", "BottomGras.png"))
ground2 = Ground(width= 500, height=250, x=500, y=350, vel=10, img=os.path.join("images", "BottomGras.png"))
    #list for all ground and background objects
grounds = [bg1, bg2, ground1, ground2]
    #graphics list
